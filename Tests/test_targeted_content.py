...
class Phase2Tests(unittest.TestCase):
    def test_width_21_sibling_boss_evidence_invalidates_profile(self):
        ...
        profiles[0]['evidence'].update({
            ...
            'candidate_clusters': (
                ...
                {'values': (213, 223, 234), 'width': 21, 'center': 223.333333,
                 'count': 3},
            ),
            '_candidate_item_records': tuple({
                ...
                (60, 60), (61, 60), (62, 60), (213, 80), (223, 80), (234, 80))),
        })
        ...
        boss = profiles[0]['encounters'][0]
        self.assertFalse(profiles[0].get('valid', True))
        self.assertFalse(boss['evidence']['valid'])
        self.assertTrue(boss['targets'])
