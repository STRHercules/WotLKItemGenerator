        ...
        <div className="panel-body">
          <div className="forge-scene" data-testid="forge-scene" data-phase={state.lifecycle} data-heat={heat} aria-hidden="true">
            ...
            <div className="forge-machine">
              <div className="forge-hammer" data-testid="forge-hammer" data-pivot="handle-end" data-handle-attachment="head-right-center"><span className="forge-hammer-handle" /><span className="forge-hammer-head"><span className="forge-striking-face" /></span></div>
