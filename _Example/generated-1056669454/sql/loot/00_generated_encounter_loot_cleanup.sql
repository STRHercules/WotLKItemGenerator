...
START TRANSACTION;
DELETE FROM `reference_loot_template` WHERE `Entry` IN (3100000, 3100001, 3100002, 3100003, 3100005, 3100006, 3100007) OR `Reference` IN (3100000, 3100001, 3100002, 3100003, 3100005, 3100006, 3100007);
...
-- Removes only generated encounter pools and attachments.
START TRANSACTION;
DELETE FROM `reference_loot_template` WHERE `Entry` IN (3250000, 3250001, 3250002, 3250004, 3250006, 3250012) OR `Reference` IN (3250000, 3250001, 3250002, 3250004, 3250006, 3250012);
...
-- Removes only generated encounter pools and attachments.
START TRANSACTION;
DELETE FROM `reference_loot_template` WHERE `Entry` IN (3520000, 3520001, 3520002) OR `Reference` IN (3520000, 3520001, 3520002);
...
-- Removes only generated encounter pools and attachments.
START TRANSACTION;
DELETE FROM `reference_loot_template` WHERE `Entry` IN (3530000, 3530002, 3530003) OR `Reference` IN (3530000, 3530002, 3530003);
...
-- Removes only generated encounter pools and attachments.
START TRANSACTION;
DELETE FROM `reference_loot_template` WHERE `Entry` IN (3600000, 3600002) OR `Reference` IN (3600000, 3600002);
...
-- Removes only generated encounter pools and attachments.
START TRANSACTION;
DELETE FROM `reference_loot_template` WHERE `Entry` IN (3650001) OR `Reference` IN (3650001);
...
-- Removes only generated encounter pools and attachments.
START TRANSACTION;
DELETE FROM `reference_loot_template` WHERE `Entry` IN (3760000) OR `Reference` IN (3760000);
