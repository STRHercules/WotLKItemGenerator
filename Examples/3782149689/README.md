...
Deterministic seed: `3782149689`<br>
Output directory: `generated-3782149689`<br>
...
World-loot source: `Data/creature_loot_template.sql`<br>
Reference-loot source: `Data/reference_loot_template.sql`<br>
Dungeon/raid source files: `Data/Map.dbc, Data/MapDifficulty.dbc, Data/DungeonMap.dbc, Data/creature.sql, Data/creature_template.sql, Data/instance_encounters.sql`<br>
Optional gameobject source files: `Data/gameobject.sql, Data/gameobject_template.sql, Data/gameobject_loot_template.sql`<br>
...
Script reward mapping: `EXERCISED` (files scanned: `693`, candidate reward calls: `78`, validated mappings: `13`, rejected mappings: `626`)<br>
Item-template source: `Data/item_template.sql`<br>
Client Item.dbc sources: `Data/Item.dbc, Data/Item.custom.dbc`<br>
ItemSet.dbc source: `Data/ItemSet.dbc`<br>
Spell.dbc source: `Data/Spell.dbc`<br>
SpellItemEnchantment.dbc source: `Data/SpellItemEnchantment.dbc`<br>
Disenchant source: `Data/disenchant_loot_template.sql`<br>
Spell proc source: `Data/spell_proc.sql`<br>
Spell script source: `Data/spell_script_names.sql`<br>
Disabled new features: `none`<br>
Feature counts: `{"chance-on-hit": 106, "disenchant": 99061, "on-use": 434, "sets": 200, "socket-bonuses": 6865, "spell-effects": 805}`<br>
